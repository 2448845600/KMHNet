...
class TrafficStateExecutor(AbstractExecutor):
    def __init__(self, config, model, data_feature):
        ...
        self.work_dir = self.config.get('work_dir', './libcity/cache')
        self.cache_dir = os.path.join(self.work_dir, '{}/model_cache'.format(self.exp_id))
        self.evaluate_res_dir = os.path.join(self.work_dir, '{}/evaluate_cache'.format(self.exp_id))
        self.summary_writer_dir = os.path.join(self.work_dir, '{}/'.format(self.exp_id))
